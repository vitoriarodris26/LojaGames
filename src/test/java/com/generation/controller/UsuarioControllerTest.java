...
public class UsuarioControllerTest {
	...
	@Test
	@Order(2)
	@DisplayName("Não deve permitir duplicação do nome de Usuário")
	public void naoPodeMesmoNome() {

		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Thiago Silva", "thiago_silva@email.com.br", "13465278910", "https://i.imgur.com/T12NIp9.jpg"));

		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
			"Thiago Silva", "thi_silva@email.com.br", "13465278", "https://i.imgur.com/T12NIp9.jpg"));
	...
	@Test
	@Order(4)
	@DisplayName("Listar todos os nome de  Usuários")
	public void deveMostrarNomeUsuarios() {
		...
		ResponseEntity<String> resposta = testRestTemplate
			.withBasicAuth("root", "root")
			.exchange("/usuarios/nome", HttpMethod.GET, null, String.class);
